...
const { createParty, filterPartiesByUser, viewSingleParty, editParty, deleteParty, getPartyGuests, searchPartiesByLocation } = PartyController
...
router.get('/:party_id/guests', auth, getPartyGuests)
